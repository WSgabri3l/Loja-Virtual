...
const buyButton = document.querySelector("#nav-content-buy-button-buy");
        ...
        productImage.addEventListener("click", (event) =>{
            ...
            productModalButton.addEventListener("click", (event) =>{
                ...
                buyCarItemRemoveButton.addEventListener("click", (event) =>{
                    ...
                    //Remocao da Lista de Compras
                    //Com o findIndex, será percorrida a lista de ids até encontrar uma que bata com a selecionada, assim, a removendo.
                    buyList.splice(buyList.findIndex((value) => value.id = products[index].id), 1);
                ...
                //Lista de items e sessionStorage
                let buyItem = {
...
buyButton.addEventListener("click", (event) =>{
    ...
    //JSON
    sessionStorage.setItem("buyInfo", JSON.stringify(buyList));
    console.log(buyList);
